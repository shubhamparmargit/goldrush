...
function openBankDetailsSheet() {
    ...
    document.getElementById("sheetContent").innerHTML = `
        ...
        <div class="sheet-divider">Bank Document <small>(any one)</small></div>
        <div class="sheet-row">
            <label class="f14-regular mb-6 d-block">Cancelled Cheque</label>
            <input type="file" id="wd_cancelled_cheque" class="form-control" accept=".jpg,.jpeg,.png,.pdf">
        </div>
        <div class="sheet-row">
            <label class="f14-regular mb-6 d-block">Passbook</label>
...
function submitBankDetailsForWithdrawal() {
    ...
    if (!cancelledCheque && !passbook) { showError("Upload Cancelled Cheque or Passbook"); return; }
...
function openWithdrawalAmountSheet() {
    ...
    document.getElementById("sheetContent").innerHTML = `
        ...
        <div class="sheet-divider">Enter Withdrawal Amount</div>
...
function submitWithdrawal(amount) {
