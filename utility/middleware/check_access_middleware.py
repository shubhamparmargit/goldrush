...
PAGE_ACCESS = {
    ...
    "contact_messages":[1],
    "portal_users":[1],
    "registration_report":[1, 2, 3, 4, 5],
    "transaction_report":[1, 2, 3, 4, 5],
    "wallet_recharge_report":[1, 2, 3, 4, 5],
    "first_recharge_report":[1, 5],
    "franchise_report":[1, 5],
    "customer_report":[1, 5],
    "customer_transfer_report":[1, 5],
    "order_report":[1, 5],
    "no_recharge_report":[1, 5],
    "inactive_customer_report":[1, 5],
    "withdrawal_report":[1, 2, 3, 4, 5],
    "live_order_report":[1, 2, 3, 4, 5],
    "franchise_commission_report":[1, 2, 3, 4, 5],
    "franchise_wise_report":[1, 2, 3, 4, 5],
    "closeLiveOrder":[1, 5],
    "ledger_report":[1, 5],
    "get_customer_ledger":[1, 5],
    "export_bulk_ledger":[1, 5],
    "macReset":[1, 5],
    "getCustomer":[1, 5],
    "getCustomerForEdit":[1, 5],
    "updateCustomer":[1, 5],
    "getCustomerOrderDetails":[1, 5],
    "updateOrderStatus":[1, 5],
    "getCustomerCartDetails":[1, 5],
    "getAllDataByTable":[1, 2, 3, 4, 5],
    'add_wallet_page': [1, 5],
    ...
    'spread_settings_page': [1, 5],
    'save_spread_settings': [1, 5],
}
