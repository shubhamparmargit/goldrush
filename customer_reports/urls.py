...
urlpatterns = [
   ...
   re_path(r'^live-order-report$', page_obj.live_order_report, name='live_order_report'),
   re_path(r'^high-value-live-orders-report$', page_obj.high_value_live_orders_report, name='high_value_live_orders_report'),
   re_path(r'^franchise-commission-report$', page_obj.franchise_commission_report, name='franchise_commission_report'),
   re_path(r'^franchise-wise-report$', page_obj.franchise_wise_report, name='franchise_wise_report'),
