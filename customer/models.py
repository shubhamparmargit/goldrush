...
class Customer(models.Model):
    ...
    aadhaar_number = models.CharField(max_length=12, unique=True, null=True, blank=True, default=None)
    aadhaar_front_image = models.CharField(max_length=300, blank=True, null=True, default='')
    aadhaar_back_image = models.CharField(max_length=300, blank=True, null=True, default='')
    pan_number = models.CharField(max_length=10, unique=True, null=True, blank=True, default=None)
    pan_front_image = models.CharField(max_length=300, blank=True, null=True, default='')
    mobile = models.CharField(max_length=10,unique=True)
    email = models.CharField(max_length=255, unique=True, null=True, blank=True, default=None)
